...
double TrajectoryLineFollower::delta_h(double y_s, double phi_s, double te)
{
...
double TrajectoryLineFollower::delta_v(double y_s, double phi_s, double te, double dh)
{
